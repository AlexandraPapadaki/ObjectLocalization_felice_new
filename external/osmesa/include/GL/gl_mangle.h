...
#define GL_MANGLE_C2 "This file is used to create GL function protypes and aliases for the function names"
	files="gl.h glext.h  ../GLES/gl.h ../GLES2/gl2.h ../GLES3/gl3.h ../GLES3/gl31.h ../GLES3/gl32.h"
...
#define GL_MANGLE_C4 get aliases
	grep '^GL_\?API' $files | sed -e 's/.*ENTRY gl\([^( ]*\).*$/#define gl\1		MANGLE(\1)/' | sort | uniq
	echo ""
...
#define glAlphaFuncx		MANGLE(AlphaFuncx)
#define glAlphaFuncxOES		MANGLE(AlphaFuncxOES)
#define glApplyFramebufferAttachmentCMAAINTEL		MANGLE(ApplyFramebufferAttachmentCMAAINTEL)
...
#define glBlendBarrier		MANGLE(BlendBarrier)
...
#define glCallCommandListNV		MANGLE(CallCommandListNV)
...
#define glClearColorx		MANGLE(ClearColorx)
...
#define glClearDepthx		MANGLE(ClearDepthx)
...
#define glClipPlanef		MANGLE(ClipPlanef)
#define glClipPlanefOES		MANGLE(ClipPlanefOES)
#define glClipPlane		MANGLE(ClipPlane)
#define glClipPlanex		MANGLE(ClipPlanex)
...
#define glColor4x		MANGLE(Color4x)
...
#define glCommandListSegmentsNV		MANGLE(CommandListSegmentsNV)
#define glCompileCommandListNV		MANGLE(CompileCommandListNV)
...
#define glConservativeRasterParameterfNV		MANGLE(ConservativeRasterParameterfNV)
#define glConservativeRasterParameteriNV		MANGLE(ConservativeRasterParameteriNV)
...
#define glCoverageModulationNV		MANGLE(CoverageModulationNV)
#define glCoverageModulationTableNV		MANGLE(CoverageModulationTableNV)
...
#define glCreateCommandListsNV		MANGLE(CreateCommandListsNV)
...
#define glCreateStatesNV		MANGLE(CreateStatesNV)
...
#define glDeleteCommandListsNV		MANGLE(DeleteCommandListsNV)
...
#define glDeleteStatesNV		MANGLE(DeleteStatesNV)
...
#define glDepthRangex		MANGLE(DepthRangex)
...
#define glDrawCommandsAddressNV		MANGLE(DrawCommandsAddressNV)
#define glDrawCommandsNV		MANGLE(DrawCommandsNV)
#define glDrawCommandsStatesAddressNV		MANGLE(DrawCommandsStatesAddressNV)
#define glDrawCommandsStatesNV		MANGLE(DrawCommandsStatesNV)
...
#define glEvaluateDepthValuesARB		MANGLE(EvaluateDepthValuesARB)
...
#define glFramebufferSampleLocationsfvARB		MANGLE(FramebufferSampleLocationsfvARB)
#define glFramebufferSampleLocationsfvNV		MANGLE(FramebufferSampleLocationsfvNV)
...
#define glGetCommandHeaderNV		MANGLE(GetCommandHeaderNV)
...
#define glGetCoverageModulationTableNV		MANGLE(GetCoverageModulationTableNV)
...
#define glGetFixedv		MANGLE(GetFixedv)
...
#define glGetInternalformatSampleivNV		MANGLE(GetInternalformatSampleivNV)
...
#define glGetLightxv		MANGLE(GetLightxv)
...
#define glGetMaterialxv		MANGLE(GetMaterialxv)
...
#define glGetnUniformi64vARB		MANGLE(GetnUniformi64vARB)
#define glGetnUniformivARB		MANGLE(GetnUniformivARB)
#define glGetnUniformiv		MANGLE(GetnUniformiv)
#define glGetnUniformui64vARB		MANGLE(GetnUniformui64vARB)
...
#define glGetQueryBufferObjecti64v		MANGLE(GetQueryBufferObjecti64v)
#define glGetQueryBufferObjectiv		MANGLE(GetQueryBufferObjectiv)
#define glGetQueryBufferObjectui64v		MANGLE(GetQueryBufferObjectui64v)
#define glGetQueryBufferObjectuiv		MANGLE(GetQueryBufferObjectuiv)
...
#define glGetStageIndexNV		MANGLE(GetStageIndexNV)
...
#define glGetTexEnvxv		MANGLE(GetTexEnvxv)
...
#define glGetTexParameterxv		MANGLE(GetTexParameterxv)
...
#define glGetUniformi64vARB		MANGLE(GetUniformi64vARB)
...
#define glGetUniformui64vARB		MANGLE(GetUniformui64vARB)
...
#define glIsCommandListNV		MANGLE(IsCommandListNV)
...
#define glIsStateNV		MANGLE(IsStateNV)
...
#define glListDrawCommandsStatesClientNV		MANGLE(ListDrawCommandsStatesClientNV)
...
#define glLoadMatrixx		MANGLE(LoadMatrixx)
...
#define glMaterialx		MANGLE(Materialx)
#define glMaterialxOES		MANGLE(MaterialxOES)
#define glMaterialxv		MANGLE(Materialxv)
...
#define glMaxShaderCompilerThreadsARB		MANGLE(MaxShaderCompilerThreadsARB)
...
#define glMultiTexCoord4x		MANGLE(MultiTexCoord4x)
...
#define glMultMatrixx		MANGLE(MultMatrixx)
...
#define glNamedFramebufferSampleLocationsfvARB		MANGLE(NamedFramebufferSampleLocationsfvARB)
#define glNamedFramebufferSampleLocationsfvNV		MANGLE(NamedFramebufferSampleLocationsfvNV)
...
#define glNormal3x		MANGLE(Normal3x)
...
#define glOrthof		MANGLE(Orthof)
#define glOrthofOES		MANGLE(OrthofOES)
#define glOrtho		MANGLE(Ortho)
#define glOrthox		MANGLE(Orthox)
...
#define glPointParameterx		MANGLE(PointParameterx)
#define glPointParameterxv		MANGLE(PointParameterxv)
#define glPointParameterxvOES		MANGLE(PointParameterxvOES)
#define glPointSize		MANGLE(PointSize)
#define glPointSizePointerOES		MANGLE(PointSizePointerOES)
#define glPointSizex		MANGLE(PointSizex)
...
#define glPolygonOffsetClampEXT		MANGLE(PolygonOffsetClampEXT)
#define glPolygonOffsetEXT		MANGLE(PolygonOffsetEXT)
#define glPolygonOffset		MANGLE(PolygonOffset)
#define glPolygonOffsetx		MANGLE(PolygonOffsetx)
...
#define glPrimitiveBoundingBoxARB		MANGLE(PrimitiveBoundingBoxARB)
#define glPrimitiveBoundingBox		MANGLE(PrimitiveBoundingBox)
...
#define glProgramUniform1i64ARB		MANGLE(ProgramUniform1i64ARB)
#define glProgramUniform1i64NV		MANGLE(ProgramUniform1i64NV)
#define glProgramUniform1i64vARB		MANGLE(ProgramUniform1i64vARB)
...
#define glProgramUniform1ui64ARB		MANGLE(ProgramUniform1ui64ARB)
#define glProgramUniform1ui64NV		MANGLE(ProgramUniform1ui64NV)
#define glProgramUniform1ui64vARB		MANGLE(ProgramUniform1ui64vARB)
...
#define glProgramUniform2i64ARB		MANGLE(ProgramUniform2i64ARB)
#define glProgramUniform2i64NV		MANGLE(ProgramUniform2i64NV)
#define glProgramUniform2i64vARB		MANGLE(ProgramUniform2i64vARB)
...
#define glProgramUniform2ui64ARB		MANGLE(ProgramUniform2ui64ARB)
#define glProgramUniform2ui64NV		MANGLE(ProgramUniform2ui64NV)
#define glProgramUniform2ui64vARB		MANGLE(ProgramUniform2ui64vARB)
...
#define glProgramUniform3i64ARB		MANGLE(ProgramUniform3i64ARB)
#define glProgramUniform3i64NV		MANGLE(ProgramUniform3i64NV)
#define glProgramUniform3i64vARB		MANGLE(ProgramUniform3i64vARB)
...
#define glProgramUniform3ui64ARB		MANGLE(ProgramUniform3ui64ARB)
#define glProgramUniform3ui64NV		MANGLE(ProgramUniform3ui64NV)
#define glProgramUniform3ui64vARB		MANGLE(ProgramUniform3ui64vARB)
...
#define glProgramUniform4i64ARB		MANGLE(ProgramUniform4i64ARB)
#define glProgramUniform4i64NV		MANGLE(ProgramUniform4i64NV)
#define glProgramUniform4i64vARB		MANGLE(ProgramUniform4i64vARB)
...
#define glProgramUniform4ui64ARB		MANGLE(ProgramUniform4ui64ARB)
#define glProgramUniform4ui64NV		MANGLE(ProgramUniform4ui64NV)
#define glProgramUniform4ui64vARB		MANGLE(ProgramUniform4ui64vARB)
...
#define glRasterSamplesEXT		MANGLE(RasterSamplesEXT)
...
#define glStateCaptureNV		MANGLE(StateCaptureNV)
...
#define glSubpixelPrecisionBiasNV		MANGLE(SubpixelPrecisionBiasNV)
...
#define glTexEnvx		MANGLE(TexEnvx)
#define glTexEnvxOES		MANGLE(TexEnvxOES)
#define glTexEnvxv		MANGLE(TexEnvxv)
...
#define glTexParameterx		MANGLE(TexParameterx)
#define glTexParameterxOES		MANGLE(TexParameterxOES)
#define glTexParameterxv		MANGLE(TexParameterxv)
...
#define glTranslatex		MANGLE(Translatex)
...
#define glViewportPositionWScaleNV		MANGLE(ViewportPositionWScaleNV)
#define glViewportSwizzleNV		MANGLE(ViewportSwizzleNV)
...
#define glWindowRectanglesEXT		MANGLE(WindowRectanglesEXT)
